...
#include "akros2_msgs/msg/detail/mode__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = akros2_msgs::msg::Mode;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const akros2_msgs::msg::Mode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<akros2_msgs::msg::Mode *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_akros2_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<akros2_msgs::msg::Mode>()
{
  return &akros2_msgs::msg::typesupport_fastrtps_cpp::_Mode__handle;
}
