...
class Metaclass_Mode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('akros2_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'akros2_msgs.msg.Mode')
            logger.debug(
...
class Mode(metaclass=Metaclass_Mode):
    ...
    def __init__(self, **kwargs):
        ...
        self.auto_t = kwargs.get('auto_t', bool())
    ...
    @builtins.property
    def auto_t(self):
        """Message field 'auto_t'."""
        return self._auto_t

    @auto_t.setter
    def auto_t(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'auto_t' field must be of type 'bool'"
        self._auto_t = value
